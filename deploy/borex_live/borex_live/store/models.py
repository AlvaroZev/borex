...
class TheoryState(Base):
    """Persistent paper portfolio/strategy checkpoint, isolated from MT5."""

    __tablename__ = "theory_state"
...
class TheoryTrade(Base):
    """A shadow/backtest trade. This table is never consumed by execution code."""

    __tablename__ = "theory_trades"
    __table_args__ = (
        UniqueConstraint(
            "symbol",
            "entry_time",
            "pattern",
            name="uq_theory_trade_signal",
        ),
    )
